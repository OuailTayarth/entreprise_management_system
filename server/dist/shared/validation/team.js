...
exports.TeamCreateSchema = zod_1.z.object({
    ...
    collaborationScore: zod_1.z.coerce.number().min(0).max(100).default(0),
    productivityScore: zod_1.z.coerce.number().min(0).max(100).default(0),
    qualityScore: zod_1.z.coerce.number().min(0).max(100).default(0),
});
